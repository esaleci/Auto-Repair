...
// Static data to avoid any data loading issues
const staticRepairOrders = [
  {
    id: "ro1",
    orderNumber: "RO-001",
  ...
  },
  {
    ...
    vehicle: { make: "Chevrolet", model: "Malibu", year: 2021 },
  },
]
...
const staticLocations = [
  { name: "Downtown Auto Repair", orders: 18 },
  { name: "Uptown Auto Repair", orders: 12 },
  { name: "Westside Auto Repair", orders: 15 },
  { name: "Eastside Auto Repair", orders: 9 },
]

export default function Dashboard() {
  // Calculate completion percentage
  const completedOrders = staticRepairOrders.filter((order) => order.status === "COMPLETED").length
  const totalOrders = staticRepairOrders.length
    ...
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6 bg-background">
          ...
          <CardContent>
            ...
            <div className="mt-4 text-center">
              <Button variant="outline" asChild>
                <Link href="/repair-orders">View All Orders</Link>
              </Button>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="col-span-3">
          ...
          <CardContent className="px-2">
            <div className="h-[300px] w-full flex items-center justify-center bg-muted/20 rounded-md">
              <p className="text-muted-foreground">Repair time analytics visualization</p>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        ...
        <Card className="col-span-4">
          ...
          <CardContent className="px-2">
            <div className="h-[300px] w-full flex items-center justify-center bg-muted/20 rounded-md">
              <p className="text-muted-foreground">Revenue overview visualization</p>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            <div className="h-[180px] w-full mb-4 flex items-center justify-center bg-muted/20 rounded-md">
              <p className="text-muted-foreground">Location performance visualization</p>
            </div>
            <div className="space-y-2">
              {staticLocations.map((location) => (
                <div key={location.name} className="flex items-center justify-between">
                  <div className="font-medium">{location.name}</div>
                  <div className="text-sm">{location.orders} orders</div>
                </div>
              ))}
            </div>
          </CardContent>
